            ...
            es: {
                translation: {
                    ...
                    labels: {
                        ...
                        noItemsData: "Nada por aqui. Al parecer este usuario aun no carga ningun producto...",
                        noItemsDataSubtitle: "Hace click en el boton + para comenzar a agregar productos",
                        ...
                        userNoExist: "Ups! Al parecer no existe ningun usuario con esos datos."
                    },
                    button: {
                        login: "Ingresar",
                        createAccount: "Crear Cuenta",
